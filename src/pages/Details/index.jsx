      ...
      <Content>
        ...
        <div className="movie-title">
          ...
          <div className="user-span">
            <img src="https://github.com/santos-vital.png" alt="Foto do usuário" />
            <span>Por Leandro Vital</span>
        ...
        <p>
          ...
          desconhecida que está enviando mensagens codificadas através de radiação gravitacional, deixando coordenadas em binário que os 
          levam até uma instalação secreta da NASA liderada pelo professor John Brand. O cientista revela que um buraco de minhoca foi 
          aberto perto de Saturno e que ele leva a planetas que podem oferecer condições de sobrevivência para a espécie humana. 
          ...
          Endurance e recuperar os dados dos astronautas; se um dos planetas se mostrar habitável, a humanidade irá seguir para ele na instalação da NASA, 
